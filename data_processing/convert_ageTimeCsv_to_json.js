...
const DATA_PATH = `${__dirname}/import/ageTimeData.csv`;
const OUTPUT_PATH = `${__dirname}/../export/ageTimeData.json`;
...
let pushJson = function(dataRow)
{
    ...
    for(let i in jsonData.headers)
    {
        ...
        //Calculate total
        if(Number(i) > 0 && Number(dataRow[i]) && i != 7)
...
let convertJsonToChartJS = function()
{
    ...
    dataObjects["18-29"].hidden = false;
